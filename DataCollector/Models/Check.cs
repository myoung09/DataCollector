...
namespace DataCollector.Models
{
    internal class Check
    {
        ...
        public Check(Worksheet excelWorksheet, string timeOfCheck, string huNumber, string weights, string diametersMin, string diametersMax, string productCode, string lotCode, string defects, string packaging, int checkNumber)
        {
